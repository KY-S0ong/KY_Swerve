...
public class SwerveTurn extends SubsystemBase {
  ...
  private final AnalogInput flEncoder = new AnalogInput(0);

  /* Front Right Turn */
  private final TalonFX frTurn = new TalonFX(27);
  private final AnalogInput frTurnEncoder = new AnalogInput(1);

  /* Back Left Turn */
  private final TalonFX blTurn = new TalonFX(23);
  private final AnalogInput blEncoder = new AnalogInput(2);

  /* Back Right Turn */
  private final TalonFX brTurn = new TalonFX(26);
  private final AnalogInput brEncoder = new AnalogInput(3);
